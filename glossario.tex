...
\newacronym[description={\glslink{B2C}{Business-to-Consumer}}]
...
\newglossaryentry{Activiti Workflow Engine}{
    ...
    description={Activiti è una leggera piattaforma per workflow e BPM (Business Process Management). Il suo cuore è l'engine BPMN2 (Business Process Model and Notation) per Java. È open-source e distribuito attraverso licenza Apache. Activiti funziona in qualsiasi applicazione Java, su un server, su un cluster o nel cloud. Si integra con Spring, è estremamente leggero e basato su concetti semplici
}}