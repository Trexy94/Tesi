...
Nel caso del progetto da me sviluppato si è usato PostgreSQL, per i motivi già esposti.
...
È necessario quindi creare una tabella, che verrà chiamata per comodità da adesso clienti.
...
\item\texttt{clienti.get.js} che contiene le istruzioni necessarie a generare l’header. È necessario includere nell’html la linea <@processJsonModel group="share"/>.
