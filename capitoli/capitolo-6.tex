...
\item \texttt{TODO:aggiungere funzione per mail} che si occupa di generare un piccolissimo form JQuery per l'inserimento del testo della mail e di fare una chiamata AJAX al servizio TODO:inserire nome per mandare la mail al gruppo a cui è stato assegnato il progetto;
\end{itemize}
...
\end{itemize}
\subsubsection{classe che non mi ricordo, se c'era}
